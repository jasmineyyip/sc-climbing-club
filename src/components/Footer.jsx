            ...
            <div className="footer-wrapper">
                <div className="footer-content">
                    ...
                    <div className="left-panel">
                        ...
                        <div className="socials footer">
                            ...
                            <a href="https://join.slack.com/t/scclimbingclub/shared_invite/zt-3chfr2ncn-AuZZb9rnEe~a6ScbzrmY1w" target="_blank" rel="noopener noreferrer">
                ...
                <div className="liner">
                    <div className="liner-content">
                        ...
                        <p>Made with ❤️ by <a href="https://www.linkedin.com/in/jasmine-yyy/" target='_blank'>Jasmine Yip</a>, Social & DEI Chair</p>
                    </div>
                </div>
            </div>
        </footer>
